...
import { fetchBooksByCollection } from "@/store/thunks/bookThunk";
...
const BookByCollectionScreen = ({ params }: { params: PageParams }) => {
  const { loading, bookListByCollection, booksByCollection, bookParam } =
  ...
  return (
    <Box sx={{ width: "100%", px: 8, py: 3 }}>
      ...
      <TablePagination
        ...
        component="div"
        count={bookListByCollection.meta?.total || 0}
        rowsPerPage={perPage}
        page={page}
...
export default BookByCollectionScreen;
