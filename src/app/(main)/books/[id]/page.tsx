...
import { fetchBooksBySubCategory } from "@/store/thunks/bookThunk";
import { BooksBySubCategory } from "@/types/books";
...
const BookScreen = ({ params }: { params: PageParams }) => {
  const { loading, bookListBySubCategory, booksBySubCategory, bookParam } =
  ...
  return (
    <Box sx={{ width: "100%", px: 8, py: 3 }}>
      ...
      <TablePagination
        ...
        component="div"
        count={bookListBySubCategory.meta?.total || 0}
        rowsPerPage={perPage}
        page={page}
